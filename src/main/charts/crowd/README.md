...
| crowd.tomcatConfig.acceptCount | string | `"10"` |  |
...
| crowd.tomcatConfig.maxThreads | string | `"100"` |  |
| crowd.tomcatConfig.mgmtPort | string | `"8005"` |  |
| crowd.tomcatConfig.minSpareThreads | string | `"10"` |  |
